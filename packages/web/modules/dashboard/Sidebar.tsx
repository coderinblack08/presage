...
export const Sidebar: React.FC<SidebarProps> = ({}) => {
  ...
  return (
    <nav className="flex flex-col relative h-screen w-[21.5rem] flex-shrink-0 border-r">
      ...
      <ul className="pt-6 pb-8 space-y-1.5 border-b">
        <li className="px-9 bg-gray-100 py-3 w-full">
          <a className="flex items-center space-x-3 w-full text-gray-800">
            <Home className="w-5 h-5" />
            <span className="font-semibold">Learn</span>
          </a>
        </li>
        <li className="px-9 py-3 w-full">
          <a className="flex items-center space-x-3 w-full text-gray-500">
        ...
        <li className="px-9 py-3 w-full">
          <a className="flex items-center space-x-3 w-full text-gray-500">
            <EmojiEventsOutlined className="w-5 h-5" />
