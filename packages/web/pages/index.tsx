...
const RadialGradient = () => {
  return (
    <div className="absolute top-0 flex justify-center w-full">
      <svg
        className="max-w-2xl lg:max-w-3xl w-full"
...
const Home: NextPage = () => {
  return (
    <div>
      <RadialGradient />
      <Navbar />
      <header className="flex flex-col items-center space-y-5 md:space-y-6 text-center py-20 lg:py-28 px-8">
        ...
        <p className="text-gray-600 !leading-loose text-sm sm:text-base md:text-lg max-w-xl md:max-w-2xl">
        ...
        <form className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-3 max-w-xl w-full mt-4 sm:mt-6">
