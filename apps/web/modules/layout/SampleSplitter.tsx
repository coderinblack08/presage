...
const SampleSplitter: React.FC<SplitterProps & { isDragging: boolean }> = ({
  ...
  return (
    <div
      ...
      ref={splitterRef}
      className={cn(
        "focus:outline-none flex-shrink-0 w-2 -ml-2 relative z-50 h-screen border-r bg-zinc-50 border-gray-200 cursor-col-resize hover:border-r-4 hover:border-blue-400 transition",
