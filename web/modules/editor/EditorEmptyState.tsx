  ...
  return (
    <div className="select-none">
      ...
      <div className="grid grid-cols-2 mt-12">
        <div>
          <h6 className="text-gray-400 font-bold mb-4">Get Started</h6>
        ...
        <div>
          <h6 className="text-gray-400 font-bold mb-4">Writing Guides</h6>
          <ul className="space-y-4">
            <li className="text-gray-400 flex items-center space-x-2">
              <IconCheck className="w-6 h-6 text-gray-300" />
              <a>Bullet Journalism</a>
            </li>
            <li className="text-gray-400 flex items-center space-x-2">
              <IconCheck className="w-6 h-6 text-gray-300" />
              <a>Fighting Writer&apos;s Block</a>
            </li>
            <li className="text-gray-400 flex items-center space-x-2">
              <IconCheck className="w-6 h-6 text-gray-300" />
              <a>Storytelling for Beginners</a>
            </li>
            <li className="text-gray-400 flex items-center space-x-2">
              <IconCheck className="w-6 h-6 text-gray-300" />
